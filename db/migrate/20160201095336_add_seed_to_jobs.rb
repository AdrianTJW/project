class AddSeedToJobs < ActiveRecord::Migration
  ...
  def up
    50.times do |i|
      Job.create(company_name: "Company with name ##{i}", description: "A product.", address: "statue of liberty", country: "Mexico", city:"Mexico City", type:"WorkingHoliday", job_name:"great job", salary:"100", start_date: "12/15/2015", end_date: "12/15/2015")
    end
    50.times do |i|
